...
class Utilisateur {
    ...
    // Constructor
    public function __construct(?int $id_util, ?string $prenom, ?string $nom, ?DateTime $dt_naiss, ?string $mail, ?int $num, ?string $mdp, ?string $typee, ?string $q1 = '', ?string $rp1 = '', ?string $q2 = '', ?string $rp2 = '', ?string $auth = '', ?string $img = '', ?int $score = 0) {
