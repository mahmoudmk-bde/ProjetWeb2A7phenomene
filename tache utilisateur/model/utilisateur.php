...
class Utilisateur {
    ...
    private ?string $q2;
    private ?string $rp2;
    private ?string $auth; // NOUVEAU CHAMP
    
    // Constructor - AJOUT DU CHAMP AUTH
    public function __construct(?int $id_util, ?string $prenom, ?string $nom, ?DateTime $dt_naiss, ?string $mail, ?int $num, ?string $mdp, ?string $typee, ?string $q1 = '', ?string $rp1 = '', ?string $q2 = '', ?string $rp2 = '', ?string $auth = '') {
        ...
        $this->q2 = $q2;
        $this->rp2 = $rp2;
        $this->auth = $auth; // INITIALISATION
    }

    // Méthode pour afficher les informations de l'utilisateur - AJOUT AUTH
    public function show() {
        echo "<table border='1' cellpadding='5'>";
        echo "<tr><th>ID</th><th>Prénom</th><th>Nom</th><th>Date de naissance</th><th>Email</th><th>Téléphone</th><th>Type</th><th>Auth</th></tr>";
        echo "<tr>";
        ...
        echo "<td>{$this->auth}</td>"; // AFFICHAGE AUTH
        echo "</tr>";
        echo "</table>";
    }

    // Méthode pour afficher sous forme de carte - AJOUT AUTH
    public function showCard() {
        ...
        echo "<p><strong>Auth:</strong> {$this->auth}</p>"; // AFFICHAGE AUTH
        echo "</div>";
    }

    // GETTER ET SETTER POUR AUTH
    ...
    // Les autres getters/setters restent les mêmes...
