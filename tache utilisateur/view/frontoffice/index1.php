            ...
            <div class="col-md-7 offset-sm-1">
              <div class="live_stareams_slide owl-carousel">
                <div class="live_stareams_slide_img">
                  <img src="assets/img/live_streams_1.png" alt="" />
                ...
                <div class="live_stareams_slide_img">
                  <img src="assets/img/live_streams_2.png" alt="" />
                  <div class="extends_video">
                    <a
                      id="play-video_1"
                      class="video-play-button popup-youtube"
                ...
                >
                  <div class="col-lg-6">
                    <div class="single_war_text text-center">
                      ...
                      <a href="#">view fight</a>
                      <div
                        class="war_text_item d-flex justify-content-around align-items-center"
                      >
                        <img src="assets/img/war_logo_1.png" alt="" />
                        <h2>190<span>vs</span>189</h2>
                        <img src="assets/img/war_logo_2.png" alt="" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xl-12">
              <div class="gallery_part_item">
                <div class="grid">
                  ...
                  <a
                    href="assets/img/gallery/gallery_item_1.png"
                    class="grid-item bg_img img-gal grid-item--height-1"
                    style="
                      background-image: url('assets/img/gallery/gallery_item_1.png');
                    "
                  >
                  ...
                  <a
                    href="assets/img/gallery/gallery_item_2.png"
                    class="grid-item bg_img img-gal"
                    style="
                      background-image: url('assets/img/gallery/gallery_item_2.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
                  ...
                  <a
                    href="assets/img/gallery/gallery_item_3.png"
                    class="grid-item bg_img img-gal"
                    style="
                      background-image: url('assets/img/gallery/gallery_item_3.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
                  ...
                  <a
                    href="assets/img/gallery/gallery_item_5.png"
                    class="grid-item bg_img img-gal grid-item--height-2"
                    style="
                      background-image: url('assets/img/gallery/gallery_item_5.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
                  ...
                  <a
                    href="assets/img/gallery/gallery_item_7.png"
                    class="grid-item bg_img img-gal grid-item--height-2"
                    style="
                      background-image: url('assets/img/gallery/gallery_item_7.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
                  ...
                  <a
                    href="assets/img/gallery/gallery_item_6.png"
                    class="grid-item bg_img img-gal grid-item--width-1"
                    style="
                      background-image: url('assets/img/gallery/gallery_item_6.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
                  ...
                  <a
                    href="assets/img/gallery/gallery_item_4.png"
                    class="grid-item bg_img img-gal sm_weight grid-item--height-1"
                    style="
                      background-image: url('assets/img/gallery/gallery_item_4.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
