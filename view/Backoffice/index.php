        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="fas fa-chart-line"></i> Activité Récente</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>John Doe</td>
                                            <td>Mission "Recyclage" complétée</td>
                                            <td>15 Jan 2024</td>
                                            <td><span class="badge badge-success">Terminé</span></td>
                                        </tr>
                                        <tr>
                                            <td>Jane Smith</td>
                                            <td>Nouvelle réclamation déposée</td>
                                            <td>15 Jan 2024</td>
                                            <td><span class="badge badge-warning">En attente</span></td>
                                        </tr>
                                        <tr>
                                            <td>Mike Johnson</td>
                                            <td>Inscription nouvelle utilisateur</td>
                                            <td>14 Jan 2024</td>
                                            <td><span class="badge badge-info">Nouveau</span></td>
                                        </tr>
                                        <tr>
                                            <td>Sarah Wilson</td>
                                            <td>Participation événement écologique</td>
                                            <td>14 Jan 2024</td>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="fas fa-tachometer-alt"></i> Statistiques Rapides</h5>
                        </div>
                        <div class="card-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item list-group-item-action">
                                    ...
                                    <small>Missions terminées avec succès</small>
                                </a>
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-1">Utilisateurs Actifs</h6>
                                        <span class="text-info">892</span>
                                    </div>
                                    <small>Ces 7 derniers jours</small>
                                </a>
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-1">Satisfaction</h6>
                                        <span class="text-warning">4.2/5</span>
                                    </div>
                                    <small>Note moyenne des utilisateurs</small>
                                </a>
                                <a href="#" class="list-group-item list-group-item-action">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-1">Engagement</h6>
                                        <span class="text-primary">65%</span>
                                    </div>
                                    <small>Taux d'engagement global</small>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="fas fa-bolt"></i> Actions Rapides</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <button class="btn btn-primary btn-block">
                                        <i class="fas fa-calendar-plus"></i> Créer Événement
                                    </button>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <button class="btn btn-primary btn-block">
                                        <i class="fas fa-bullhorn"></i> Envoyer Notification
                                    </button>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <button class="btn btn-primary btn-block">
