    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="?controller=AdminPartenaire&action=store" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <!-- Nom -->
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="type" name="type" data-validate="required">
                                    ...
                                    <option value="sponsor" <?= ($old['type'] ?? '') === 'sponsor' ? 'selected' : '' ?>>
                                        Sponsor</option>
                                    <option value="testeur" <?= ($old['type'] ?? '') === 'testeur' ? 'selected' : '' ?>>
                                        Testeur</option>
                                    <option value="vendeur" <?= ($old['type'] ?? '') === 'vendeur' ? 'selected' : '' ?>>
                                        Vendeur</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <small class="form-text" style="color: var(--text-muted);">Formats acceptés: JPG, PNG,
                                ...
                                <div class="mt-3" id="logo-preview-container" style="display: none;">
                                    ...
                                    <img id="logo-preview" src="" alt="Aperçu du logo" class="img-thumbnail"
