    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="mb-4">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background: transparent; padding: 0;">
                        <li class="breadcrumb-item"><a href="?controller=AdminStore&action=index"
                                style="color: var(--primary-color);">Store</a></li>
                        <li class="breadcrumb-item active" style="color: var(--text-muted);">Modifier
                            #<?= $this->storeItem->id ?></li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="?controller=AdminStore&action=update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nom" name="nom"
                                    value="<?= htmlspecialchars($this->storeItem->nom) ?>" data-validate="required">
                            </div>
...
=======
                                    <input type="number" class="form-control" id="prix" name="prix"
                                        value="<?= htmlspecialchars($this->storeItem->prix) ?>" step="0.01" min="0"
                                        data-validate="required">
>>>>>>> 4ccea48e9ce47a01ee1e3a33112672c155a8a1ad
...
=======
                                <input type="number" class="form-control" id="stock" name="stock"
                                    value="<?= htmlspecialchars($this->storeItem->stock) ?>" min="0"
                                    data-validate="required">
>>>>>>> 4ccea48e9ce47a01ee1e3a33112672c155a8a1ad
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="categorie" name="categorie">
                                    ...
                                    <option value="sport" <?= $this->storeItem->categorie === 'sport' ? 'selected' : '' ?>>
                                        Sport</option>
                                    ...
                                    <option value="rpg" <?= $this->storeItem->categorie === 'rpg' ? 'selected' : '' ?>>RPG
                                    </option>
                                ...
                                <?php if ($this->storeItem->image): ?>
                                    <div class="mb-3">
                                        ...
                                        <img src="<?php echo BASE_URL . htmlspecialchars($this->storeItem->image); ?>"
                                            alt="Image actuelle" class="game-image" style="max-width: 200px;">
