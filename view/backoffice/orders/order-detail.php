                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><strong>Livraison:</strong> <span
                                        class="badge badge-info"><?php echo htmlspecialchars($order['shipping']); ?></span>
                                </p>
                            </div>
                        </div>
                        <p class="mt-2"><strong>Total:</strong> <?php echo number_format((float) $order['total'], 2); ?> DT
                        </p>
                        <p><small><strong>Créée le:</strong> <?php echo htmlspecialchars($order['created_at']); ?></small>
                        </p>
                    </div>
                </div>
