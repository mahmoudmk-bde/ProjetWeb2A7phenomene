            ...
            $mail = $current_user['mail'];
                ...
                if ($num && $num != $current_user['num'] && $utilisateurController->numExists($num)) {
                    ...
                    try {
                        ...
                        $_SESSION['profile_picture'] = $current_user['img'];
...
<body>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-3 text-center">
                                            <div class="current-avatar mb-3">
                                                ...
                                                <?php else: ?>
                                                    <div id="currentAvatar" style="width: 120px; height: 120px; border-radius: 50%; background: linear-gradient(45deg, var(--primary-color), #ff6b7a); display: flex; align-items: center; justify-content: center; border: 3px solid var(--primary-color);">
                                                        <i class="fas fa-user fa-3x text-white"></i>
                                                    </div>
                                                <?php endif; ?>
                                                <!-- Prévisualisation de la nouvelle image -->
                                                <img id="imagePreview" src="" alt="Aperçu" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 3px solid #28a745; display: none; margin-top: 10px;">
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <label class="form-label">Choisir une photo depuis votre PC</label>
                                                <input type="file" class="form-control" name="profile_picture" id="profile_picture" accept=".jpg,.jpeg,.png,.gif,.webp" required>
                                                <small class="form-text text-muted">
                                                    Formats acceptés: JPG, JPEG, PNG, GIF, WebP. Taille max: 10MB
                                                </small>
                                            </div>
                                            <div class="d-flex gap-2 mt-3">
                                                <button type="submit" name="upload_picture" class="btn btn-save">
                                                    <i class="fas fa-upload me-2"></i>Mettre à jour la photo
                                                </button>
                                                <button type="button" id="cancelUpload" class="btn btn-secondary" style="display: none;">
    ...
    <script>
        ...
        // Validation de la taille du fichier avant soumission
