            ...
            <div class="col-lg-12">
              <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="index.html">
                  <img src="assets/img/ll.png" alt="logo" />
                </a>
                <button
              ...
              <div class="gallery_part_item">
                <div class="grid">
                  ...
                  <a
                    ...
                    style="
                      background-image: url('img/gallery/gallery_item_1.png');
                    "
                  >
                  ...
                  <a
                    ...
                    style="
                      background-image: url('img/gallery/gallery_item_2.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
                  ...
                  <a
                    ...
                    class="grid-item bg_img img-gal"
                    style="
                      background-image: url('img/gallery/gallery_item_3.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
                  ...
                  <a
                    ...
                    style="
                      background-image: url('img/gallery/gallery_item_5.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
                  ...
                  <a
                    ...
                    class="grid-item bg_img img-gal grid-item--height-2"
                    style="
                      background-image: url('img/gallery/gallery_item_7.png');
                    "
                  >
                    <div class="single_gallery_item">
                      <div class="single_gallery_item_iner">
