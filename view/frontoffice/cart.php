        ...
        <section class="breadcrumb_bg">
            <div class="container">
                <div class="breadcrumb_iner_item text-center">
                     <h1 class="design-title">🛒 Mon Panier</h1>
                     <p class="design-subtitle">Finalisez votre commande</p>
                     <div class="stats-panel" style="margin-top: 30px;">
                        <span><i class="fas fa-shopping-bag"></i> <strong><?= count($items) ?></strong> articles</span>
                         <span><i class="fas fa-coins"></i> Total: <strong><?= number_format($total, 2) ?> DT</strong></span>
