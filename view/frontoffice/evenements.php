    ...
    <section class="breadcrumb_bg">
        <div class="container">
            <div class="breadcrumb_iner_item text-center">
                <h1 class="design-title">📅 Événements</h1>
            </div>
        </div>
    </section>
    ...
    <section class="section_padding">
        <div class="container">
            <div class="evenements-content">
                <div class="evenements-icon">🎉</div>
                <h2>Découvrez nos événements !</h2>
                <p>
                    Ne manquez pas nos événements exclusifs : tournois, compétitions, sessions de coaching, 
                    rencontres avec des professionnels du gaming et bien plus encore. 
                    Inscrivez-vous et participez à des expériences uniques !
                </p>
                <p style="margin-top: 30px; font-size: 0.9rem; color: rgba(255, 255, 255, 0.6);">
                    ⚠️ Cette section est en cours de développement. Revenez bientôt pour découvrir tous nos événements !
                </p>
            </div>
        </div>
    </section>
