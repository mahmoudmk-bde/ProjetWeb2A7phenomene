...
<head>
    ...
    <style>
        ...
        .user-dropdown {
            ...
            top: 100%;
            right: 0;
            background: linear-gradient(135deg, #1f2235 0%, #24263b 100%);
            min-width: 200px;
            box-shadow: 0 10px 30px rgba(0, 0, 0, 0.3);
            border-radius: 10px;
            z-index: 1000;
        ...
        .user-avatar {
            ...
            height: 40px;
            border-radius: 50%;
            background: linear-gradient(135deg, #ff4a57 0%, #ff6b7a 100%);
            display: flex;
            align-items: center;
            justify-content: center;
    ...
    <div class="body_bg">
      ...
      <section class="history-section">
        <div class="history-container">
            ...
            <!-- Statistiques - MODIFIÉ: Score Moyen remplacé par Score Total -->
            ...
            <!-- Tableau d'historique - NOUVELLE MISE EN FORME -->
            <div class="history-table-container">
                ...
                <?php else: ?>
                    ...
                    <div class="empty-state">
                        ...
                        <a href="index1.php" class="btn-history">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (userWrapper && userDropdown) {
        // Gestionnaire de clic pour l'avatar utilisateur
        ...
        document.addEventListener('click', function(e) {
            if (!userWrapper.contains(e.target) && !userDropdown.contains(e.target)) {
                userDropdown.style.display = 'none';
                userDropdown.classList.remove('show');
            }
        });
