...
$full_image_path = $_SERVER['DOCUMENT_ROOT'] . '/tache utilisateur/view/frontoffice/' . $image_path;
...
if (!$image_exists) {
    ...
    $image_path = "assets/img/" . $profile_picture; // Check if this path is right for default avatar
    $image_exists = true;
}
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Only init if elements exist (meaning we are in activation mode)
            if (startBtn) {
