            ...
            <div class="col-lg-12">
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        $queryParams = $_GET;
                        // helper to build url
                        function buildPageUrl($params, $p)
                        {
                            $params['page'] = $p;
                        ...
                        <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?>">
                            <a class="page-link" href="<?= buildPageUrl($queryParams, max(1, $page - 1)) ?>"
                                aria-label="Previous">
                        ...
                        <li class="page-item <?= ($page >= $totalPages) ? 'disabled' : '' ?>">
                            <a class="page-link" href="<?= buildPageUrl($queryParams, min($totalPages, $page + 1)) ?>"
                                aria-label="Next">
