...
// Gestion des likes
$isLiked = false;
$likeCount = $likeController->getLikeCount($id);
if (isset($_SESSION['user_id'])) {
    $isLiked = $likeController->hasUserLiked($id, $_SESSION['user_id']);
}
...
<head>
    ...
    <style>
        ...
        /* Styles pour les boutons Like et Partage */
        .social-actions {
            margin-top: 20px;
        }
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="enhanced-card">
                        ...
                        <div class="text-center mb-5">
                            ...
                            <div class="social-actions mt-4" style="display: flex; justify-content: center; gap: 15px; flex-wrap: wrap; align-items: center;">
                                <!-- Bouton Like -->
                                <button id="likeBtn" class="btn-like <?= $isLiked ? 'liked' : '' ?>" 
                                    ...
                                    <span class="like-text"><?= $isLiked ? 'J\'aime' : 'J\'aime' ?></span>
                                </button>
                                ...
                                <div class="share-buttons" style="display: flex; gap: 10px;">
                                    ...
                                    <a href="https://twitter.com/intent/tweet?url=<?= urlencode((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']) ?>&text=<?= urlencode(htmlspecialchars($mission['titre'])) ?>" 
                                       target="_blank" 
...
document.getElementById('likeBtn').addEventListener('click', function() {
    ...
    fetch('../../controller/like_handler.php', {
        method: 'POST',
        body: formData
    })
    ...
    .then(data => {
        if (data.success) {
            ...
            setTimeout(() => {
                btn.querySelector('i').style.animation = 'heartBeat 0.6s ease';
            }, 10);
        } else {
