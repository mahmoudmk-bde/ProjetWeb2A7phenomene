    ...
    <section class="section_padding">
        <div class="container">
            <div class="quiz-content">
                ...
                <p>
                    Participez à nos quiz interactifs sur les jeux vidéo, les missions disponibles et bien plus encore. 
                    Gagnez des points, débloquez des badges et montez dans le classement !
                </p>
                <p style="margin-top: 30px; font-size: 0.9rem; color: rgba(255, 255, 255, 0.6);">
                    ⚠️ Cette section est en cours de développement. Revenez bientôt pour tester vos connaissances !
                </p>
            </div>
        </div>
    </section>
